...
ZERO_OBSERVABLE_TRANSITIONS_ERROR = 'No observable transitions found. At lest one transition must be marked as ' \
                                    'observable'
ZERO_FAULT_TRANSITIONS_ERROR = 'No fault transitions found. At least one transition must be marked as fault'
MULTIPLE_ATTRIBUTES_TRANSITIONS_ERROR = 'Too many attributes for a transition. At most one attribute can be assigned ' \
                                        'to a transition'
NO_EVENT_IN_OBSERVABLE_TRANSITION_ERROR = 'No event in observable transition found. Observable transitions must have ' \
                                          'an event'
EVENT_IN_UNOBSERVABLE_TRANSITION_ERROR = 'Event in unobservable transition found. Unobservable transitions must have ' \
                                         'no events'
...
def save_img(automaton, title, file_name, compact, save_source):
    ...
    :param automaton: the automaton to be saved
    :type automaton: Automaton
    :param title: the title to be displayed in the png file
    :type title: str
