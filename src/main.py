...
def check_diagnosability_level():
    ...
    if method == 1:
        result = method1(automaton, level)
        result_label['text'] = get_text_result(method, result)
    elif method == 2:
        result = method2(automaton, level)
        result_label['text'] = get_text_result(method, result)
    elif method == '3v1':
        result = method3_1(automaton, level)
        result_label['text'] = get_text_result(method, result)
    elif method == '3v2':
        result = method3_2(automaton, level)
        result_label['text'] = get_text_result(method, result)
    else:
        result1 = method1(automaton, level)
        result2 = method2(automaton, level)
        result3_1 = method3_1(automaton, level)
        result3_2 = method3_2(automaton, level)
        text_results = list()
